  ...
  return (
    <div className='about'>
      <img className='tree' src={tree} 
        ...
        alt="tree drawing" /> 
      <p className='bio'>Hello! My name is Charlie and I am a coder, musician, and animator from Santa Cruz, CA. I am a recent graduate from University of California San Diego with a degree in Computing and the Arts looking for opportunities in web development, game development, or animation. I am particularly passionate about the various applications and synthesis of code, music, and animation as a vehicle for artistic expression. I have experience using React.js, HTML, CSS, and I taught game design/animation fundamentals using Javascript for 4 years. I produce music in Ableton and Logic and I regularly use Photoshop, Premier, Animate, and Unity for game development/animations. In my free time, you can find me surfing, skating, or playing piano. Thank you for taking a look at my website and feel free to reach out using the <Link to={"/contact"} className='contact-link'>contact</Link> page!</p>
