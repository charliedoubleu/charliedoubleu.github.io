...
export default function Portfolio() {
    ...
    const [projects, setProjects] = useState([
        {title: 'sub particles', description: 'A data visualization of YouTube subscribers using YouTube API, P5.js, Node.js and Firebase', link: 'http://subparti.com/particles/charlie', thumbnail: './thumbnails/subparticles.png', tags: [2], id: 5},
        {title: 'uu', description: 'An animated music video created in Adobe Photoshop, Animate, and Premiere', link: 'https://youtu.be/ZMMSAJkdWTM', thumbnail: './thumbnails/uu.png', tags: [3], id: 4},
