...
export default function Portfolio() {
    ...
    const [projects, setProjects] = useState([
        ...
        {title: 'waterfall', description: 'A short animation inspired by a waterfall in my backyard', link: 'https://youtube.com/shorts/sbZZ0oYoPsM?feature=share', thumbnail: './thumbnails/frog.png', tags: [3], id: 5},
