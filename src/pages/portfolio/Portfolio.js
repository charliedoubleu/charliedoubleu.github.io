...
export default function Portfolio() {
    ...
    const [projects, setProjects] = useState([
        {title: 'sub particles', description: 'A data visualization of YouTube subscribers using YouTube API, P5.js, Node.js and Firebase', link: 'subparti.com', thumbnail: './thumbnails/subparticles.png', tags: [2], id: 5},
